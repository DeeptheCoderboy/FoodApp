...
function Item({data}) {
        ...
        return(
      <div className="min-h-screen px-10 overflow-hidden bg-white dark:bg-black">
      <Link href={"/"}>
      ...
      <div className="container border-gradient max-w-md p-6 md:p-8 mb-16 mx-auto  flex space-y-4 flex-col items-center justify-center">
        ...
        <div className="font-extrabold mb-2 text-base md:text-2xl uppercase  text-black dark:text-white">
          {data.name}
        </div>
        <div className=" max-w-sm text-base md:text-lg text-black dark:text-gray-400">
          {data.description}
        </div>
      </div>
    </div>
